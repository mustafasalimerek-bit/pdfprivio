...
/// Privio doing work on their behalf. We deliberately use well-known
...
class SamplePdfService {
  ...
  Future<List<int>> _buildPiiSampleBytes() async {
    final pdf = pw.Document(
      ...
      author: 'Privio',
      subject: 'Sample document for Privio demo',
    );
      ...
      pw.Page(
        ...
        build: (ctx) => pw.Column(
          ...
          children: [
            ...
            pw.Text(
              'Privio Sample Document — every identifier on this page is '
            ...
            pw.Divider(),
            pw.Text(
              'Sample generated by Privio — try Find sensitive data, '
