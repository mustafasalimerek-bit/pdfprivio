...
/// PDFPrivio doing work on their behalf. We deliberately use well-known
...
class SamplePdfService {
  ...
  Future<File> piiSampleDoc() async {
    ...
    final path = p.join(dir.path, 'pdfprivio_samples', 'account_notice.pdf');
  ...
  Future<List<int>> _buildPiiSampleBytes() async {
    final pdf = pw.Document(
      ...
      author: 'PDFPrivio',
      subject: 'Sample document for PDFPrivio demo',
    );
      ...
      pw.Page(
        ...
        build: (ctx) => pw.Column(
          ...
          children: [
            ...
            pw.Text(
              'PDFPrivio Sample Document — every identifier on this page is '
            ...
            pw.Divider(),
            pw.Text(
              'Sample generated by PDFPrivio — try Find sensitive data, '
